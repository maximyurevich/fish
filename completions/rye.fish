...
complete -c rye -n "__fish_rye_using_subcommand add" -l pin -d 'Overrides the pin operator' -r -f -a "equal\t''
tilde-equal\t''
greater-than-equal\t''"
complete -c rye -n "__fish_rye_using_subcommand add" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
...
complete -c rye -n "__fish_rye_using_subcommand init" -l build-system -d 'Which build system should be used (defaults to hatchling)?' -r -f -a "hatchling\t''
setuptools\t''
flit\t''
pdm\t''
maturin\t''"
...
complete -c rye -n "__fish_rye_using_subcommand install" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand lock" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand remove" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand sync" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand test" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand tools; and __fish_seen_subcommand_from install" -l keyring-provider -d 'Attempt to use `keyring` for authentication for index URLs' -r -f -a "disabled\t'Do not use keyring for credential lookup'
subprocess\t'Use the `keyring` command for credential lookup'"
...
complete -c rye -n "__fish_rye_using_subcommand self; and __fish_seen_subcommand_from completion" -s s -l shell -d 'The shell to generate a completion script for (defaults to \'bash\')' -r -f -a "bash\t''
elvish\t''
fish\t''
powershell\t''
zsh\t''
...
complete -c rye -n "__fish_rye_using_subcommand version" -s b -l bump -d 'The version bump to apply' -r -f -a "major\t''
minor\t''
patch\t''"
